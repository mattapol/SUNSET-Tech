...
st.sidebar.subheader('SUNSETHD 🌞')

# Retrieving tickers data
ticker_list = pd.read_csv("https://raw.githubusercontent.com/mattapol/SUNSET-Tech/main/sethd.csv")
symbols = ticker_list['Symbol'].sort_values().tolist()
ticker = st.sidebar.selectbox('Choose a SETHD Stock 📈', ticker_list) # Select ticker symbol
