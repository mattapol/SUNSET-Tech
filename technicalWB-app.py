...
st.sidebar.subheader('SUNSETWB 🌞')

# Retrieving tickers data
ticker_list = pd.read_csv("https://raw.githubusercontent.com/mattapol/SUNSET-Tech/main/setwb.csv")
symbols = ticker_list['Symbol'].sort_values().tolist()
ticker = st.sidebar.selectbox('Choose a SETWB Stock 📈', ticker_list) # Select ticker symbol
