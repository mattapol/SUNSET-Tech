...
st.sidebar.subheader('SUNSET S 🌞')

# Retrieving tickers data
ticker_list = pd.read_csv("https://raw.githubusercontent.com/mattapol/SUNSET-Tech/main/sset.csv")
symbols = ticker_list['Symbol'].sort_values().tolist()
ticker = st.sidebar.selectbox('Choose a SET S Stock 📈', ticker_list) # Select ticker symbol
